...
export const LAYOUT_GROUPS: { title: string; types: string[] }[] = [
  { title: 'Open & close', types: ['cover', 'section', 'statement', 'manifesto', 'quote'] },
  { title: 'Story', types: ['poster', 'story', 'speaker', 'persona', 'contrast', 'chat'] },
  { title: 'Data', types: ['bigNumber', 'figures', 'statGrid', 'chart', 'insight', 'table', 'comparison'] },
  { title: 'Structure', types: ['agenda', 'pillars', 'steps', 'timeline', 'bento', 'qa', 'accordion', 'tabs'] },
