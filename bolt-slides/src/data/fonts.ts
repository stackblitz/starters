...
export const FONTS: FontPairing[] = [
  ...
  { id: 'space', label: 'Space Grotesk', head: 'Space Grotesk', body: 'Inter', import: g(['Space Grotesk', 'Inter']) },
  { id: 'sora', label: 'Sora', head: 'Sora', body: 'Inter', import: g(['Sora', 'Inter']) },
  { id: 'manrope', label: 'Manrope', head: 'Manrope', body: 'Manrope', import: g(['Manrope']) },
  { id: 'dm', label: 'DM Sans', head: 'DM Sans', body: 'DM Sans', import: g(['DM Sans']) },
  { id: 'outfit', label: 'Outfit', head: 'Outfit', body: 'Inter', import: g(['Outfit', 'Inter']) },
  { id: 'playfair', label: 'Playfair Display', head: 'Playfair Display', body: 'Source Sans 3', import: g(['Playfair Display', 'Source Sans 3']) },
  { id: 'fraunces', label: 'Fraunces', head: 'Fraunces', body: 'Inter', import: g(['Fraunces', 'Inter']) },
]
...
export function applyFont(id: string | undefined) {
  ...
  r.setProperty('--font-head', `'${f.head}', 'Inter', -apple-system, sans-serif`)
  r.setProperty('--font-body', `'${f.body}', 'Inter', -apple-system, sans-serif`)
}
