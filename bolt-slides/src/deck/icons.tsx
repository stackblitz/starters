...
export const IconSidebar = () => (<svg {...base}><rect x="3" y="4" width="18" height="16" rx="2" /><path d="M10 4v16" /></svg>)
export const IconLeft = () => (<svg {...base}><path d="M15 5l-7 7 7 7" /></svg>)
export const IconRight = () => (<svg {...base}><path d="M9 5l7 7-7 7" /></svg>)
export const IconPencil = () => (<svg {...base}><path d="M4 20h4l10-10a2 2 0 0 0-3-3L5 17z" /></svg>)
export const IconExpand = () => (<svg {...base}><path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5" /></svg>)
