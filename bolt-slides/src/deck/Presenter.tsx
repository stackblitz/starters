      ...
      <header className="pres-top">
        <div className="pres-timer">
          ...
          <button
            ...
            title={elapsed === 0 && !running ? undefined : 'Reset (⇧T)'}
        ...
        <div className="pres-right">
          ...
          <button
            ...
            disabled={sizeIdx === 0}
            title={sizeIdx === 0 ? undefined : 'Smaller notes (−)'}
          ...
          {(onExit || window.opener) && (
            <button
              ...
              title={window.opener ? 'Close presenter' : 'Back to editor'}
              aria-label={
      ...
      <footer className="pres-bottom">
        <div className="pres-pager">
          <button
            type="button"
            className="pres-icon"
            title={slideIndex === 0 && clicks === 0 ? undefined : 'Previous'}
