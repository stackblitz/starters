...
/** x/y are relative to the stroke's anchor box (0..1); w is a width factor */
...
export type Stroke = {
  ...
  points: Pt[];
  anchor?: string;
  /** Viewport-fraction box used if the anchor element cannot be resolved */
