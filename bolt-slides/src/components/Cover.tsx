...
export default function Cover({ kicker, title, subtitle, image, foot, dim}: {
  kicker?: string; title: ReactNode; subtitle?: ReactNode; image?: string; dim?: number; foot?: string
  ...
  return (
    <div className="slide center">
      ...
      {subtitle && (
        <Reveal delay={0.16}>
          <p className="subhead" style={{ marginTop: 18 }}>{subtitle}</p>
        </Reveal>
      )}
      {foot && (
