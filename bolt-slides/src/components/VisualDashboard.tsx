...
const kpis = [
  { l: 'Revenue', v: <CountUp to={1.24} decimals={2} prefix="$" suffix="M" />, d: '▲ 18.2%', spark: 'M1,14 L9,11 L17,12.5 L25,8 L33,9.5 L41,5 L49,3' },
  { l: 'Active users', v: <CountUp to={48210} />, d: '▲ 9.4%', spark: 'M1,15 L9,13 L17,14 L25,10 L33,11.5 L41,7 L49,4.5' },
  { l: 'Churn', v: <CountUp to={1.9} decimals={1} suffix="%" />, d: '▼ 0.6%', spark: 'M1,4 L9,6 L17,5 L25,9 L33,8 L41,12 L49,14' },
]
...
export default function VisualDashboard() {
  ...
  return (
    <div ref={ref} className={'vframe mat' + (shown ? ' shown' : '')} style={{ width: 470, maxWidth: '100%' }}>
          ...
          <div key={k.l} className="dkpi">
            ...
            <div className="dkpi-row">
              ...
              <svg className="dspark" viewBox="0 0 50 18" aria-hidden>
                <path pathLength={1} d={k.spark} fill="none" stroke="var(--primary)" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        ))}
      </div>
      <svg viewBox="0 0 420 150" preserveAspectRatio="none" style={{ width: '100%', height: 108, display: 'block' }}>
        <defs>
        ...
        {[38, 76, 114].map((y) => (
          <line key={y} className="dgrid" x1="0" x2="420" y1={y} y2={y} vectorEffect="non-scaling-stroke" />
        ))}
