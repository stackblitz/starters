...
export default function VisualDashboard() {
  ...
  return (
    ...
    >
      ...
      <div className="dkpis">
        <div className="dkpi">
          <div className="dkpi-l">Revenue</div>
          <div className="dkpi-v">
            <CountUp to={1.24} decimals={2} prefix="$" suffix="M" />
          </div>
          <div className="dkpi-d">▲ 18.2%</div>
        </div>
        <div className="dkpi">
          <div className="dkpi-l">Active users</div>
          <div className="dkpi-v">
            <CountUp to={48210} />
          </div>
          <div className="dkpi-d">▲ 9.4%</div>
        </div>
        <div className="dkpi">
          <div className="dkpi-l">Churn</div>
          <div className="dkpi-v">
            <CountUp to={1.9} decimals={1} suffix="%" />
          </div>
          <div className="dkpi-d">▼ 0.6%</div>
        </div>
      </div>
      <svg
        viewBox="0 0 420 150"
