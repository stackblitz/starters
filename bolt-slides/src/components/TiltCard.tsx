...
export default function TiltCard({ children }: { children: ReactNode }) {
  ...
  if (isStatic || reduce) {
    return <div className="tilt-frame"><div className="tilt">{children}<span className="tilt-glare" /></div></div>
  }
  ...
  return (
    <div ref={frameRef} className="tilt-frame" onMouseMove={move} onMouseLeave={leave}>
