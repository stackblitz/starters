...
export default function Section({ n, kicker, title, image, dim}: {
  n?: number | string; kicker?: string; title: ReactNode; image?: string; dim?: number; nav?: string; notes?: string
}) {
  return (
    <div className="slide center">
      ...
      {n != null && <div className="sec-ghost" aria-hidden>{String(n).padStart(2, '0')}</div>}
      <Reveal>
        {kicker && <div className="kicker" style={{ marginBottom: 16 }}>{kicker}</div>}
